...
class ProjectProject(models.Model):
    ...
    def _get_remote_odoo(self):
        ...
        url = config.get_param('odoo_integration.url')
        db_name = config.get_param('odoo_integration.db_name')
        user_name = config.get_param('odoo_integration.user_name')
        password = config.get_param('odoo_integration.password')
