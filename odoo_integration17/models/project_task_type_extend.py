...
class ProjectTaskType(models.Model):
    ...
    def _get_remote_odoo(self):
        ...
        url = config.get_param('odoo_integration17.url')
        db_name = config.get_param('odoo_integration17.db_name')
        user_name = config.get_param('odoo_integration17.user_name')
        password = config.get_param('odoo_integration17.password')
